#!/usr/bin/env python3
"""
Unit tests for String Compression II (Problem weekly_380_p2)
...
try:
    from solution import StringCompressionIi
except ImportError:
    # Fallback if solution file doesn't exist yet
    class StringCompressionIi:
        def string_compression_ii(self, s):
            raise NotImplementedError("Solution not implemented yet")


class TestStringCompressionIi(unittest.TestCase):
    """Test cases for String Compression II."""
    
    def setUp(self):
        """Set up test fixtures before each test method."""
        self.solution = StringCompressionIi()
    
    def test_basic_string(self):
        """Test basic string functionality."""
        s = "hello world"
        result = self.solution.string_compression_ii(s)
