#!/usr/bin/env python3
"""
Unit tests for Number Game (Problem 915A)
...
class TestNumberGame(unittest.TestCase):
    ...
    def test_edge_case_single(self):
        ...
        result = self.solution.number_game("single")
    ...
    def test_multiple_cases(self):
        ...
        for input_val, expected in test_cases:
            with self.subTest(input=input_val):
                result = self.solution.number_game(input_val)
    ...
    def test_performance(self):
        ...
        result = self.solution.number_game(large_input)
        end_time = time.time()
