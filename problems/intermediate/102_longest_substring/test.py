#!/usr/bin/env python3
"""
Unit tests for Longest Substring Without Repeating Characters (Problem 102)
...
try:
    from solution import LongestSubstringWithoutRepeatingCharacters
except ImportError:
...
class TestLongestSubstringWithoutRepeatingCharacters(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.solution = LongestSubstringWithoutRepeatingCharacters()
    
    def test_basic_string(self):
        """Test basic string functionality."""
        s = "hello world"
        result = self.solution.longest_substring_without_repeating_characters(s)
