#!/usr/bin/env python3
"""
Unit tests for Next Permutation (Problem 111)
...
class TestNextPermutation(unittest.TestCase):
    ...
    def test_edge_case_single(self):
        ...
        result = self.solution.next_permutation("single")
    ...
    def test_multiple_cases(self):
        ...
        for input_val, expected in test_cases:
            with self.subTest(input=input_val):
                result = self.solution.next_permutation(input_val)
    ...
    def test_performance(self):
        ...
        result = self.solution.next_permutation(large_input)
        end_time = time.time()
