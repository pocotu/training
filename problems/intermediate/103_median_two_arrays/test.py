#!/usr/bin/env python3
"""
Unit tests for Median of Two Sorted Arrays (Problem 103)
...
try:
    from solution import MedianOfTwoSortedArrays
except ImportError:
    # Fallback if solution file doesn't exist yet
    class MedianOfTwoSortedArrays:
        def median_of_two_sorted_arrays(self, nums):
...
class TestMedianOfTwoSortedArrays(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.solution = MedianOfTwoSortedArrays()
    
    def test_basic_array(self):
        """Test basic array functionality."""
        nums = [1, 2, 3, 4, 5]
        result = self.solution.median_of_two_sorted_arrays(nums)
